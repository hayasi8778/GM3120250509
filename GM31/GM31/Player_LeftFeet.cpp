...
void Player_LeftFeet::Update(uint64_t deltatime)
{
	// 方向ベクトル作成
...
void Player_LeftFeet::Adhesioing()
{
...
Vector3 Player_LeftFeet::Conectpos(const std::string& targetName)
{

...
void Player_RightArm::Adhesioing()
{
...
Vector3 Player_RightArm::Conectpos(const std::string& targetName)
{
...
void Player_RightArm::Rockon(Vector3 rot)
{
	// 1. forward ベクトルを計算

...
void Enemy_LeftFeet::Update(uint64_t deltatime)
{
	// 方向ベクトル作成
...
void Enemy_LeftFeet::LateUpdate(uint64_t deltatime)
{

}

void Enemy_LeftFeet::Dispose()
{
...
void Enemy_LeftFeet::Action(Vector3 vec)
{

}

void Enemy_LeftFeet::Reset()
{

}

int Enemy_LeftFeet::GetShaderNum()
{
	return 0;
}

GM31::GE::Collision::BoundingBoxOBB Enemy_LeftFeet::GetOBB()
{
...
Vector3 Enemy_LeftFeet::Conectpos(const std::string& targetName)
{
